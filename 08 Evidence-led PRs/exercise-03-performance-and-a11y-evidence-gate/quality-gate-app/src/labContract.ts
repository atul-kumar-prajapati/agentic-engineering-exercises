...
export const labContract: LabContract = {
  ...
  mission: "Fix measured UI regressions and build a pessimistic gate that rejects one bad browser run or any axe violation.",
  outcome: "Reviewers receive raw, digest-bound browser evidence and a reproducible pass or fail decision from one source commit.",
  entities: ["source commit", "production build", "Lighthouse run", "axe scan", "quality threshold", "release decision"],
  seededDefects: [
