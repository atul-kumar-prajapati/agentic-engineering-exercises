...
for (const ref of [
  "refs/tags/exercise-base",
  "refs/tags/hotfix-head",
  "refs/tags/breaking-head",
  "refs/heads/exercise-head",
]) {
  if (!heads.includes(ref)) throw new Error(`Bundle is missing ${ref}`);
}

console.log("Release fixture contains full-release, hotfix-only, and internal-only comparison ranges.");
