...
export const labContract: LabContract = {
  ...
  outcome: "The cache survives save, filter, reload, malformed data, and read-only evidence scenarios without mutating shared fixtures.",
  entities: ["protected review range", "fresh reviewer session", "workflow cache", "structured findings"],
  seededDefects: ["filter changes delete saved state", "cached JSON is trusted", "default sorting mutates fixtures", "evidence collection writes stale state"],
